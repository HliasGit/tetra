...
int main(int argc, char *argv[]) {
    ...
    int size_proccesed = remove_unnecessary_cubes(grid, size, threshold, &dim, &results);
    ...
    marching_tetrahedra_list(&dim, &grid, cube_decomposition, threshold, origin,
                        ...
                        &vertex_counter, size_proccesed, results);
